(function () {
  ...
  const translations = {
    ...
    'proto.safe.tag': { fr: 'Vérification des faits · Éthique · Argumentation', en: 'Fact-checking · Ethics · Argumentation' },
    'proto.safe.subtitle': {
    ...
    'proto.singer.tag': { fr: 'Apprentissage des langues · Chant · Éducation', en: 'Language learning · Singing · Education' },
    ...
    'proto.theatre.tag': { fr: 'Théâtre · RAG · Archives', en: 'Theatre · RAG · Archives' },
    ...
    'proto.incognito.tag': { fr: 'Confidentialité · Anonymisation · Science ouverte', en: 'Privacy · Anonymization · Open science' },
    ...
    'proto.lsl.tag': { fr: 'Psychologie · Multimodal · Visualisation', en: 'Psychology · Multimodal · Visualization' },
    'proto.lsl.subtitle': {
    ...
    'proto.pdfsplitter.tag': { fr: 'PDF · OCR · Utilitaire', en: 'PDF · OCR · Utility' },
    ...
    'proto.albert.tag': { fr: 'PDF · OCR · Utilitaire', en: 'PDF · OCR · Utility' },
    'proto.albert.subtitle': {
      fr: 'OCR de PDF scannés via Albert API et le modèle openweight-ocr (LightOnOCR)',
      en: 'Scanned PDF OCR via Albert API and the openweight-ocr model (LightOnOCR)'
    },
    'proto.albert.desc': {
      fr: 'Chargez un ou plusieurs PDF (ou un dossier). Exportez en Markdown, ZIP ou JSON ; la clé reste dans votre navigateur.',
      en: 'Upload one or more PDFs (or a folder). Export as Markdown, ZIP, or JSON; the API key stays in your browser.'
    },
    'proto.albertstt.tag': { fr: 'Audio · Transcription · Relecture', en: 'Audio · Transcription · Review' },
    'proto.albertstt.subtitle': {
      fr: 'Transcription audio · SRT / VTT via Albert API',
      en: 'Audio transcription · SRT / VTT via Albert API'
    },
    'proto.albertstt.desc': {
      fr: 'Interface de relecture, correction et réalignement.',
      en: 'Interface for review, correction, and realignment.'
    },
    ...
    'proto.alt.albert': {
      fr: 'Capture d\'écran de Albert OCR',
      en: 'Screenshot of the Albert OCR interface'
    },
    'proto.alt.albertstt': {
      fr: 'Capture d\'écran de Albert Speech-to-text',
      en: 'Screenshot of the Albert Speech-to-text interface'
    },
